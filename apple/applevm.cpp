...
AppleVM::AppleVM()
{
  ...
  // A stale or corrupt pref could name a slot that does not exist; coerce
  // that to off. (The mouse used to be slot 4 only; its ROM now works in
  // any slot.)
  if (g_slotMouse > 7) g_slotMouse = 0;
